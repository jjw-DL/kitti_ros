...
with open('/home/jjw/Kitti/2011_09_26/calib_velo_to_cam.txt', 'r') as f:
    yml = yaml.load(f)
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        # publish 3d boxes
        publish_3dbox(box3d_pub, corners_3d_velos, track_ids, object_types, publish_id=True, publish_distance=False, log=log)
        # publish imu
